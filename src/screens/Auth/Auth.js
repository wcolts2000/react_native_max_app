    ...
    return (
      <ImageBackground source={backgroundImage} style={styles.image}>
        <View style={styles.container}>
          <MB_Spacer>{headingText}</MB_Spacer>
          ...
          <View style={styles.inputContainer}>
            <DefaultInput
              ...
              style={styles.input}
              valid={this.state.controls.email.value}
            ...
            >
              ...
              >
                <DefaultInput
                  ...
                  valid={this.state.controls.password.value}
              ...
              >
                <DefaultInput
                  ...
                  style={styles.input}
                  valid={this.state.controls.confirmPassword.value}
